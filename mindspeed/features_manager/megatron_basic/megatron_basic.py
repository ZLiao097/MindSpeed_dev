...
class MegatronBasicFeature(MindSpeedFeature):
    ...
    def register_mcore_basic_patches(self, pm, args):
        ...
        from mindspeed.core.megatron_basic.megatron_basic import MindSpeedSelfAttention
        pm.register_patch('megatron.core.transformer.attention.SelfAttention.get_query_key_value_tensors',
                          MindSpeedSelfAttention.get_query_key_value_tensors)
